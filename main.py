    ...
    try:
        while _running:
            ...
            ui_state.last_market_context = {
                ...
                "setup_type": getattr(bias, 'setup_type', 'NONE') if bias else "NONE",
                "bias_m15_aligned": getattr(bias, 'm15_aligned', False) if bias else False,
                "bias_tradeable": getattr(bias, 'is_tradeable', False) if bias else False,
